		...
		<div class="col-md-12">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h6 class="panel-title">yakışmadı...</h6>
				</div>
				<div class="panel-body">
					<pre>hoş olmadı bence bu hareketin. yok yani böyle bir sayfa, hadi sen geri dön.</pre>
					<a class="btn btn-primary" href="<?php echo site_url(); ?>"><i class="fa fa-chevron-left"></i> peki, dönüyorum :(</a>
